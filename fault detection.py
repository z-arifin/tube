        ...
        for cnt in contours:
            ...
            if area > 2000:
                ...
                if points>4:
                    ...
                    cv2.putText(cropCopy, "circle",(x,y+68), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0,0,255), 2)
                    cv2.rectangle(image, (0,220), (856,300), (0,0,255), cv2.FILLED)
                    cv2.putText(image, "FAULTY ITEM DETECTED", (90,200), cv2.FONT_HERSHEY_SIMPLEX,2,(255,255,255),3)
                else:
                    cv2.rectangle(cropCopy,(x,y), (x+w,y+h),(0,255,0),1)
